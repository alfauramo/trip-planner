...
export function SwipeableRow({ children, onDelete, disabled }: SwipeableRowProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl" ref={containerRef}>
      <div
        className="absolute inset-y-0 right-0 flex items-center justify-end pr-4 bg-red-500 rounded-xl transition-opacity duration-150"
      ...
      <div
        className="relative bg-white dark:bg-stone-800 z-10"
        style={{
