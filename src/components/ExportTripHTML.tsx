...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    h1 { font-size: 28px; color: #0f766e; margin-bottom: 8px; }
    h2 { font-size: 18px; color: #374151; margin: 24px 0 12px 0; border-bottom: 2px solid #0f766e; padding-bottom: 8px; }
    ...
    .event-cost { font-weight: 500; color: #0f766e; }
    ...
    .total { font-size: 20px; color: #0f766e; font-weight: 600; }
