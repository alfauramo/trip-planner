    ...
    return (
      <div className={containerCls}>
        <div className={`${cardCls} text-center`}>
          ...
          <h2 className="text-2xl font-semibold mb-2 text-gray-900 dark:text-white">¡Registro exitoso!</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">Hemos enviado un enlace de confirmación a tu email. Revisa tu bandeja de entrada.</p>
      ...
      <div className={cardCls}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Mínimo 8 caracteres, una mayúscula, una minúscula y un número</p>
          </div>
          <div>
        ...
        <div className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
          ¿Ya tienes cuenta?{' '}
          <Link to="/login" className="text-blue-500 hover:underline font-medium">Inicia sesión</Link>
        </div>
      </div>
    </div>
  );
