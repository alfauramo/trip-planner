...
export function LoginPage() {
  ...
  const cardCls = isMobile ? 'w-full' : 'max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8';
    ...
    <div className={containerCls}>
      <div className={cardCls}>
        <div className="flex items-center justify-center mb-8">
          ...
          <h1 className={`font-bold text-gray-800 dark:text-white ml-3 ${isMobile ? 'text-2xl' : 'text-3xl'}`}>
            Trip Planner
          </h1>
        </div>
        ...
        {error && (
          <div className="bg-red-50 dark:bg-red-900/50 text-red-600 dark:text-red-400 p-3 rounded-xl mb-4 text-sm">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-blue-500 text-white py-3 rounded-xl font-medium hover:bg-blue-600 active:bg-blue-700 transition-colors disabled:opacity-50"
          >
